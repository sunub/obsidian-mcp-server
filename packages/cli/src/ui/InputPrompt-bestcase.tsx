...
import { useInputState } from "@cli/contexts/InputContext.js";
import { type MouseEvent, useMouse } from "@cli/contexts/MouseContext.js";
import { useSettings } from "@cli/contexts/SettingsContext.js";
import { useShellFocusState } from "@cli/contexts/ShellFocusContext.js";
import { useUIActions } from "@cli/contexts/UIActionsContext.js";
import { useUIState } from "@cli/contexts/UIStateContext.js";
import { escapeAtSymbols } from "@cli/hooks/atCommandProcessor.js";
import { useAlternateBuffer } from "@cli/hooks/useAlternateBuffer.js";
import {
	CompletionMode,
	useCommandCompletion,
} from "@cli/hooks/useCommandCompletion.js";
...
import { useKittyKeyboardProtocol } from "@cli/hooks/useKittyKeyboardProtocol.js";
import { useMouseClick } from "@cli/hooks/useMouseClick.js";
import { useRepeatedKeyPress } from "@cli/hooks/useRepeatedKeyPress.js";
import { useReverseSearchCompletion } from "@cli/hooks/useReverseSearchCompletion.js";
import { useShellHistory } from "@cli/hooks/useShellHistory.js";
import { formatCommand } from "@cli/key/keybindingUtils.js";
import { Command } from "@cli/key/keyMatchers.js";
import { theme } from "@cli/semantic-colors.js";
import { SCREEN_READER_USER_PREFIX } from "@cli/textConstants.js";
import { getSafeLowColorBackground } from "@cli/themes/color-utils.js";
import { StreamingState } from "@cli/types.js";
import { MAX_WIDTH, SuggestionsDisplay } from "@cli/ui/SuggestionsDisplay.js";
import { HalfLinePaddedBox } from "@cli/ui/shared/HalfLinePaddedBox.js";
import {
	ScrollableList,
	type ScrollableListRef,
} from "@cli/ui/shared/ScrollableList.js";
import {
	...
	logicalPosToOffset,
	type TextBuffer,
} from "@cli/ui/shared/text-buffer.js";
import {
	cleanupOldClipboardImages,
	clipboardHasImage,
	saveClipboardImage,
} from "@cli/utils/clipboardUtils.js";
import {
	isAutoExecutableCommand,
	isSlashCommand,
} from "@cli/utils/commandUtils.js";
import {
	parseInputForHighlighting,
	parseSegmentsFromTokens,
} from "@cli/utils/highlight.js";
import { useIsHelpDismissKey } from "@cli/utils/shortcutsHelp.js";
import { isLowColorDepth } from "@cli/utils/terminalUtils.js";
import {
	cpIndexToOffset,
	cpLen,
	cpSlice,
	toCodePoints,
} from "@cli/utils/textUtils.js";
import {
	ApprovalMode,
	type Config,
	coreEvents,
			...
			segments.forEach((seg, segIdx) => {
				...
				const color =
					seg.type === "command" || seg.type === "file" || seg.type === "paste"
						...
						: theme.text.primary;
				renderedLine.push(
					<Text key={`token-${segIdx}-${seg.type}`} color={color}>
						{display}
					</Text>,
				);
			});
