...
// This ensures all checks and downloads are restricted to our managed directory.
...
async function setup() {
  ...
  if (finalResults.every((r) => r)) {
    ...
    finalCheckSpinner.fail(
      chalk.red.bold("Verification failed. Some files might be missing."),
    );
    console.log(
      chalk.yellow(
